...
CREATE TABLE `estimates` (
  `estimated_id` int NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `estimates_ibfk_1` FOREIGN KEY (`chain_id`) REFERENCES `chains` (`chain_id`)
...
-- Dump completed on 2025-04-10 20:49:28
